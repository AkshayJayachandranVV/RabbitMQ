...
const recieveMsg = async () => {
    ...
    await channel.assertExchange(exchangeName,'topic', {durable:false})  // first checks EXCHANGE EXIST OR NOT , create queue   durable? -- rabitMq restart wont create a quueue
